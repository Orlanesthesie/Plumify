...
return [
    ...
    'user_edit' => [['id'], ['_controller' => 'App\\Controller\\BookController::edit'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/profile/edit']], [], [], []],
    ...
    'App\Controller\BookController::edit' => [['id'], ['_controller' => 'App\\Controller\\BookController::edit'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/profile/edit']], [], [], []],
